...
case 's_service_request':
    ...
    if ($id > 0) {
        $detailData = json_encode([
            'volt' => $input['tbl_volt_pre'] ?? null,
            'amp' => $input['tbl_amp_pre'] ?? null,
            'term_remote' => $input['tbl_term_remote_pre'] ?? null,
            'psil' => $input['tbl_psil_pre'] ?? null,
            'psih' => $input['tbl_psih_pre'] ?? null,
            'fcu_out' => $input['tbl_fcu_out_pre'] ?? null,
            'fcu_in' => $input['tbl_fcu_in_pre'] ?? null,
            'cdu_out' => $input['tbl_cdu_out_pre'] ?? null,
            'cdu_in' => $input['tbl_cdu_in_pre'] ?? null,
        ...
        if ($input['id'] !== 'new') {
            $db->where('service_request_id', $id)->delete('service_request_detail');
        }
